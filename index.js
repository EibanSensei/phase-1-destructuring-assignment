...
let animals = farmAnimals.split(' '); // Split the string into an array
animals.splice(1, 1); // Remove 'horse' from the array
farmAnimals = animals.join(' '); // Join the array back into a string and assign it back
console.log(farmAnimals); // Output: cow sheep pig chicken
